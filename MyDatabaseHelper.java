package ca.mohawk.myapplication3;
...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "matchSurvey";
    public static final int DATABASE_VERSION = 1;
    public static final String TABLE_NAME = "Questionnaire";
    public static final String COLUMN_id = "id";
    public static final String COLUMN_QUESTION = "yourQuestion";
    public static final String COLUMN_ANSWERS = "yourAnswers";


    private static final String SQL_CREATE =
            "CREATE TABLE " + TABLE_NAME + " ( " + COLUMN_id + " INTEGER PRIMARY KEY, " +
                    COLUMN_QUESTION + " TEXT, " + COLUMN_ANSWERS + " TEXT) ";
